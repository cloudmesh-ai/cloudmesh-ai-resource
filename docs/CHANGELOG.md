...
All notable changes to `cloudmesh-ai-resource` will be documented in this file.
...
- **Visual Enhancements**: Introduced `console.banner` for final resource results to improve readability and visual hierarchy.
...
### Added
- **SSH resource Command**: Introduced the `resource` command to measure actual data transfer rates over SSH.
...
- **Test Suite**: Added unit and integration tests in `tests/test_resource.py` to ensure accuracy of speed measurements.
